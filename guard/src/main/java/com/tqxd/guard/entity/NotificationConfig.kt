...
data class NotificationConfig(
     ...
     * 渠道id
     */
    var channelId: String = "Guard",
    /**
     * 渠道名
     */
    var channelName: String = "Guard",
    /**
     * 标题名
     */
    var title: String = "Guard",
    /**
     * 通知栏内容
     */
    var content: String = "Guard is running",
    /**
     * 小图标
     */
    var smallIcon: Int = R.drawable.icon_guard_small,
    /**
     * 大图标
     */
    var largeIcon: Int = 0,
    ...
    constructor(source: Parcel) : this(
        source.readInt(),
        source.readString() ?: "Guard",
        source.readString() ?: "Guard",
        source.readString() ?: "Guard",
        source.readString() ?: "The app of guard is running",
        source.readInt(),
        source.readInt(),
